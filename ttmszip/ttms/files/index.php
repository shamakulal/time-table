...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="assets/img/ALVAS.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/alvas1.jpg" alt="Flower">
        </div>
...
<!-- <div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        ...
        <button type="submit" class="btn btn-info btn-lg" style="margin-top: 10px">Click here</button>
    </form>
</div> -->
<!-- The Modal -->
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/reena.jpeg" class="img-rounded"/>
                    <h3 align="center">Mrs. reena lobo</h3>
                    <hr/>
                    <h4 align="center">faculty<br/>AIET</h4>
           ...
           <!-- <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center"> Dr. Peter Fernandes</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> AIET</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr. Manjunath Kotari</h3>
                    <hr/>
                    <h4 align="center">HOD<br/>Computer science and Engineering </h4>
